file_icons = {
    -1: 'icons/View_Details-128.png',
    0: 'icons/file-128.png',
    1: 'icons/document-128.png',
    2: 'icons/film-128.png',
    3: 'icons/music-128.png',
    4: 'icons/picture-128.png'
}

additional_icons = [
    'icons/subs-128.png', #0 subtitles
    'icons/informatics-128.png', #1 nfo files
    'icons/firefox_copyrighted-128.png', #2 firefox logo
    'icons/adobe_photoshop_copyrighted-128.png', #3 photoshop
    'icons/adobe_flash_copyrighted-128.png', #4 flash
    'icons/adobe_illustrator_copyrighted-128.png', #5 illustrator
    'icons/php-128.png', #6 PHP
    'icons/python-128.png', #7 Python
    'icons/java_coffee_cup_logo_copyrighted-128.png', #8 Java
    'icons/database-128.png', #9 DB
    'icons/grid-128.png', #10 excel
    'icons/mysql-128.png', #11 mysql
    'icons/archive2-128.png', #12 archive
    'icons/linux-128.png', #13 Linux
    'icons/run_command-128.png', #14 command prompt
    'icons/key_security-128.png', #15 security
    'icons/cd-128.png', #16 cd, image files
    'icons/download-128.png', #17 download icon
    'icons/burn_cd-128.png', #18 iso, dmg, etc
    'icons/trash-128.png', # 19, trash bin
    'icons/folder_back-128.png', # 20 folder move back
    'icons/folder-128.png' #21
]
