file_icons = {
    -1: 'icons/128/Data/View_Details-128.png',
    0: 'icons/128/Very_Basic/file-128.png',
    1: 'icons/128/Very_Basic/document-128.png',
    2: 'icons/128/Photo_Video/film-128.png',
    3: 'icons/128/Very_Basic/music-128.png',
    4: 'icons/128/Very_Basic/picture-128.png'
}

additional_icons = [
    'icons/128/Photo_Video/subs-128.png', #0 subtitles
    'icons/128/Science/informatics-128.png', #1 nfo files
    'icons/128/Operating_Systems/firefox_copyrighted-128.png', #2 firefox logo
    'icons/128/Logos/adobe_photoshop_copyrighted-128.png', #3 photoshop
    'icons/128/Logos/adobe_flash_copyrighted-128.png', #4 flash
    'icons/128/Logos/adobe_illustrator_copyrighted-128.png', #5 illustrator
    'icons/128/Programming/php-128.png', #6 PHP
    'icons/128/Programming/python-128.png', #7 Python
    'icons/128/Programming/java_coffee_cup_logo_copyrighted-128.png', #8 Java
    'icons/128/Data/database-128.png', #9 DB
    'icons/128/Data/grid-128.png', #10 excel
    'icons/128/Data/mysql-128.png', #11 mysql
    'icons/128/Folders/archive2-128.png', #12 archive
    'icons/128/Operating_Systems/linux-128.png', #13 Linux
    'icons/128/User_Interface/run_command-128.png', #14 command prompt
    'icons/128/Security/key_security-128.png', #15 security
    'icons/128/Computer_Hardware/cd-128.png', #16 cd, image files
    'icons/128/Very_Basic/download-128.png', #17 download icon
    'icons/128/Computer_Hardware/burn_cd-128.png', #18 iso, dmg, etc
    'icons/128/Industry/trash-128.png', # 19, trash bin
    'icons/128/Very_Basic/folder_back-128.png', # 20 folder move back
    'icons/128/Very_Basic/folder-128.png' #21
]

additional_icons_exts = {
...
def set_icons(env, files):
    img_dir = '/static/themes/%s/img/' % env['theme_name']

    for f in files:
        if f.file_isdir:
            if f.file_name == '..':
                f.img_icon = img_dir + additional_icons[20]
            else:
                f.img_icon = img_dir + additional_icons[21]
        elif f.file_ext in additional_icons_exts:
            f.img_icon = img_dir + additional_icons[additional_icons_exts[f.file_ext]]
        else:
            f.img_icon = img_dir + file_icons[f.file_format]
